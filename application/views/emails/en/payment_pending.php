...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>Your appointment has been booked. Please complete the payment to confirm your booking.</p>
            ...
            <div class="details">
                ...
                <p><strong>Amount Due:</strong> <?php echo $payment_currency; ?> <?php echo $payment_amount; ?></p>
            </div>

            <p style="text-align: center;">
                <a href="<?php echo $payment_link; ?>" class="button">Pay Now</a>
            </p>
