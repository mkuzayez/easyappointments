...
<body>
    <div class="container">
        <div class="header">
            <h1>تم إعادة جدولة الموعد</h1>
        </div>

        <div class="content">
            <p>عزيزي/عزيزتي <?php echo $customer_name; ?>,</p>

            <p>تم إعادة جدولة موعدك. يرجى الاطلاع على التفاصيل الجديدة أدناه.</p>

            <div class="details">
                <h3>تفاصيل الموعد الجديد</h3>
                <p><strong>الطبيب:</strong> <?php echo $provider_name; ?></p>
                <p><strong>التاريخ الجديد:</strong> <?php echo $new_appointment_date; ?></p>
                <p><strong>الوقت الجديد:</strong> <?php echo $new_appointment_time; ?></p>
                <p><strong>الفرع:</strong> <?php echo $branch_name; ?></p>
                <p><strong>الخدمة:</strong> <?php echo $service_name; ?></p>
            </div>

            <p style="text-align: center;">
                <a href="<?php echo $reschedule_link; ?>" class="button">إعادة الجدولة مرة أخرى</a>
