...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>تم حجز موعدك. يرجى إتمام الدفع لتأكيد الحجز.</p>
            ...
            <div class="details">
                ...
                <p><strong>المبلغ المستحق:</strong> <?php echo $payment_amount; ?> <?php echo $payment_currency; ?></p>
            </div>

            <p style="text-align: center;">
                <a href="<?php echo $payment_link; ?>" class="button">ادفع الآن</a>
            </p>
